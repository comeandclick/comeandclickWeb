          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                <h3>Découverte</h3>
                <p>
                  Comprendre votre marque, vos objectifs et votre audience cible pour créer une stratégie
                </p>
                <ul>
                  <li>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Création de designs beaux et conviviaux qui donnent vie à votre vision
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Conception UI/UX
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Conception visuelle
                  </li>
                  <li>
            ...
            <div className="single-process">
              ...
              <div className="content">
                ...
                <ul>
                  ...
                  <li>
                    <i className="bi bi-plus" /> Soutien continu
                  </li>
                </ul>
              </div>
            </div>
