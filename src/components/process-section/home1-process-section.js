        ...
        <div className="col-lg-8">
          <div className="section-title text-animation">
            ...
            <div className="dash-and-paragraph">
              <div className="dash" />
              <p>We follow a proven design process to create stunning websites and digital experiences that help businesses stand out and succeed online.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="col-lg-4 col-sm-6">
          <div className="single-process">
            ...
            <div className="content">
              <h3>Discovery</h3>
              <p>Understanding your brand, goals and target audience to create strategy</p>
              <ul>
                <li><i className="bi bi-plus" /> Brand Analysis</li>
                <li><i className="bi bi-plus" /> User Research</li>
                <li><i className="bi bi-plus" /> Design Planning</li>
              </ul>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-sm-6">
          <div className="single-process">
            ...
            <div className="content">
              ...
              <p>Crafting beautiful, user-friendly designs that bring your vision to life</p>
              <ul>
                <li><i className="bi bi-plus" /> UI/UX Design</li>
                <li><i className="bi bi-plus" /> Visual Design</li>
                <li><i className="bi bi-plus" /> Prototyping</li>
              </ul>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-sm-6">
          <div className="single-process">
            ...
            <div className="content">
              ...
              <p>Launching your design and ensuring everything works perfectly</p>
              <ul>
                <li><i className="bi bi-plus" /> Quality Testing</li>
                <li><i className="bi bi-plus" /> Design Launch</li>
                <li><i className="bi bi-plus" /> Ongoing Support</li>
              </ul>
            </div>
          </div>
        </div>
