                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p style={{textAlign: "justify"}}>
                      Nous suivons une approche systématique pour fournir des
                      solutions numériques exceptionnelles. Notre processus
                      éprouvé garantit des résultats de qualité grâce à une
                      planification minutieuse, une exécution et une
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      ...
                      <p>
                        Nous commençons par comprendre en profondeur vos
                        objectifs commerciaux, votre public cible et les
                        exigences du projet.
                      </p>
                      <ul>
                        <li>
                          <i className="bi bi-plus" /> Analyse de Marché
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Étude de la Concurrence
                        </li>
                        <li>
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    <div className="icon">
                      ...
                      >
                        <path
                          d="M58.3331 63C58.3331 50.1144 47.8856 39.6669 35 39.6669C22.1144 39.6669 11.6669 50.1144 11.6669 63H7C7 47.537 19.537 35 35 35C50.463 35 63 47.537 63 63H58.3331ZM39.6669 7C39.6669 19.8856 50.1144 30.3338 63 30.3338V35C47.537 35 35 22.463 35 7H39.6669Z"
                          fill="#0077b6"
                        />
                        <path
                          d="M56 21C59.866 21 63 17.866 63 14C63 10.134 59.866 7 56 7C52.134 7 49 10.134 49 14C49 17.866 52.134 21 56 21Z"
                          fill="#0077b6"
                        />
                        <path
                    ...
                    <div className="content">
                      ...
                      <p>
                        Création de designs fonctionnels et visuellement
                        attrayants qui s'alignent avec votre identité de marque.
                      </p>
                      <ul>
                        <li>
                        ...
                        <li>
                          <i className="bi bi-plus" /> Maquettage
                        </li>
                        <li>
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      ...
                      <p>
                        Construction de solutions robustes utilisant des
                        technologies de pointe et des tests approfondis.
                      </p>
                      <ul>
                        <li>
                          <i className="bi bi-plus" /> Développement Sur Mesure
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Assurance Qualité
                        </li>
                        <li>
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    <div className="icon">
                      ...
                      >
                        <path
                          d="M8.87109 17.9175H15.6444V51.0733H8.87109V17.9175ZM20.5935 17.9175H27.3668V51.0733H20.5935V17.9175ZM31.8339 17.9175H38.6072V51.0733H31.8339V17.9175Z"
                          fill="#0077b6"
                        />
                        <path
                    ...
                    <div className="content">
                      ...
                      <p>
                        Assurer un déploiement en douceur et fournir une
                      ...
                      <ul>
                        ...
                        <li>
                          <i className="bi bi-plus" /> Surveillance des
                          Performances
                        </li>
                        <li>
