      ...
      <div className="row mb-60">
        <div className="col-lg-12">
          <div className="section-title three text-animation">
            <h2>Our Solution<br /><span>Process</span>
            </h2>
            <div className="dash-and-paragraph three">
              ...
              <div className="btn-and-paragraph">
                 <p>We follow a systematic approach to deliver exceptional digital solutions. Our proven process ensures quality results through careful planning, execution and continuous refinement.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="single-process-static">
              <div className="single-process">
                ...
                <div className="content">
                  ...
                  <ul>
                    <li><i className="bi bi-plus" /> Market Analysis</li>
                    <li><i className="bi bi-plus" /> Competitor Research</li>
                    <li><i className="bi bi-plus" /> Strategy Development</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="single-process-static">
              <div className="single-process">
                ...
                <div className="content">
                  ...
                  <p>Creating visually appealing and functional designs that align with your brand identity.</p>
                  <ul>
                    <li><i className="bi bi-plus" /> UI/UX Design</li>
                    <li><i className="bi bi-plus" /> Wireframing</li>
                    <li><i className="bi bi-plus" /> Interactive Prototypes</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="single-process-static">
              <div className="single-process">
                ...
                <div className="content">
                  ...
                  <p>Building robust solutions using cutting-edge technologies and thorough testing.</p>
                  <ul>
                    <li><i className="bi bi-plus" /> Custom Development</li>
                    <li><i className="bi bi-plus" /> Quality Assurance</li>
                    <li><i className="bi bi-plus" /> Performance Testing</li>
                    <li><i className="bi bi-plus" /> Security Testing</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="single-process-static">
              <div className="single-process">
                ...
                <div className="content">
                  ...
                  <p>Ensuring smooth deployment and providing ongoing maintenance and support.</p>
                  <ul>
                    <li><i className="bi bi-plus" /> Deployment</li>
                    <li><i className="bi bi-plus" /> Performance Monitoring</li>
                    <li><i className="bi bi-plus" /> Regular Updates</li>
                    <li><i className="bi bi-plus" /> Technical Support</li>
                  </ul>
                </div>
              </div>
            </div>
