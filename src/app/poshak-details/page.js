      ...
      <div className="details-page-wrapper portfolio-details pt-130 pb-130">
        <div className="container-lg container-fluid">
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Poshak : Vêtements Pakistanais Authentiques pour Femmes</h1>
                <ul className="post-category">
                  <li>
                    <Link href="#">Mode Pakistanaise</Link>
                  </li>
                  <li>
                    <Link href="#">Vêtements Traditionnels</Link>
                  </li>
                  <li>
                    <Link href="#">Mode Femme</Link>
                  </li>
                  <li>
                    <Link href="#">Artisanat</Link>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="details-page-content mb-130">
            <h3>Aperçu de la Collection</h3>
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  Poshak est votre destination pour des vêtements pakistanais authentiques 
                  et élégants pour femmes. Notre collection met en valeur la richesse 
                  de l'artisanat traditionnel pakistanais, avec des pièces soigneusement 
                  sélectionnées pour leur qualité et leur authenticité.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  Chaque vêtement raconte une histoire unique de savoir-faire artisanal, 
                  combinant des techniques traditionnelles avec des designs contemporains. 
                  Nous nous engageons à offrir des pièces authentiques qui célèbrent 
                  la beauté de la culture pakistanaise.
                </p>
              </div>
            </div>
            <span className="line-break" />
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                <h3>Notre Collection & Services</h3>
                <p>
                  Notre collection comprend une large gamme de vêtements traditionnels 
                  pakistanais, chacun reflétant l'élégance et la sophistication de 
                  la mode sud-asiatique.
                </p>
                <br />
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    Conseils personnalisés en style
                  </li>
                </ul>
              </div>
              <div className="col-lg-6">
                <img src="/assets/img/poshak/5.png" alt="" />
              </div>
            </div>
            <span className="line-break" />
            <span className="line-break" />
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                <h3>Notre Engagement envers l'Authenticité</h3>
                <p>
                  Nous collaborons directement avec des artisans pakistanais pour 
                  vous offrir des vêtements authentiques de la plus haute qualité. 
                  Chaque pièce est soigneusement sélectionnée pour sa beauté et 
                  son artisanat traditionnel.
                </p>
                <br />
                <p>
                  Notre collection met en valeur la richesse des textiles pakistanais, 
                  des broderies artisanales et des designs traditionnels, tout en 
                  intégrant des touches modernes pour répondre aux goûts contemporains.
                </p>
              </div>
            </div>
            <span className="line-break" />
