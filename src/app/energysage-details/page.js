      ...
      <div className="details-page-wrapper portfolio-details pt-130 pb-130">
        <div className="container-lg container-fluid">
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Energy Sage : Solutions d'Équipement Solaire</h1>
                <ul className="post-category">
                  <li>
                    <Link href="#">Panneaux Solaires</Link>
                  </li>
                  <li>
                    <Link href="#">Énergie Renouvelable</Link>
                  </li>
                  <li>
                    <Link href="#">Équipement Solaire</Link>
                  </li>
                  <li>
                ...
                >
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/energysage/1.png"
                        alt=""
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/energysage/2.png"
                        alt=""
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/energysage/3.png"
                        alt=""
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/energysage/4.png"
                        alt=""
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/energysage/5.png"
                        alt=""
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
          ...
          <div className="details-page-content mb-130">
            ...
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  Energy Sage est un fournisseur leader de solutions d'équipement solaire, 
                  offrant des produits innovants et durables pour les installations solaires 
                  résidentielles et commerciales. Notre expertise s'étend des panneaux solaires 
                  aux systèmes d'énergie solaire complets, y compris les onduleurs et les 
                  solutions de montage.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  Nous nous distinguons par notre expertise technique et notre engagement 
                  envers la qualité. Chaque projet reçoit une attention méticuleuse aux 
                  détails, garantissant des installations impeccables et des résultats qui 
                  dépassent les attentes de nos clients en matière de solutions d'énergie 
                  renouvelable.
                </p>
              </div>
            </div>
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                <h3>Notre Approche & Services</h3>
                <p>
                  Notre approche se concentre sur la création de solutions solaires 
                  personnalisées qui correspondent parfaitement aux besoins spécifiques 
                  de chaque client tout en assurant une performance optimale et la 
                  durabilité des systèmes d'énergie renouvelable.
                </p>
                <br />
                <ul>
                  <li>
                    ...
                    Installation et Personnalisation de Panneaux Solaires
                  </li>
                  <li>
                    <svg
                      width={16}
                    ...
                    Systèmes d'Onduleurs Haute Performance
                  </li>
                  <li>
                    <svg
                      width={16}
                    ...
                    Solutions de Stockage d'Énergie Solaire
                  </li>
                  <li>
                    <svg
                      width={16}
                    ...
                    Service de Conseil et d'Expertise Technique
                  </li>
                </ul>
              </div>
              <div className="col-lg-6">
                <img src="/assets/img/energysage/5.png" alt="" />
              </div>
            </div>
            <span className="line-break" />
            <span className="line-break" />
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                ...
                <p>
                  Nous utilisons des technologies de pointe et des équipements 
                  innovants pour garantir des résultats exceptionnels. Notre 
                  équipe expérimentée maîtrise les dernières technologies 
                  solaires et leurs applications.
                </p>
                <br />
                <p>
                  Chaque projet bénéficie d'une attention particulière, de 
                  l'évaluation initiale à l'installation finale, assurant ainsi 
                  une performance optimale et une satisfaction client maximale.
                </p>
              </div>
            </div>
            <span className="line-break" />
...
export default EnergysageDetails;
