      ...
      <div className="details-page-wrapper portfolio-details pt-130 pb-130">
        <div className="container-lg container-fluid">
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Akram - Premium Real Estate Agency.</h1>
                <ul className="post-category">
                  <li>
                    <Link href="#">Real Estate</Link>
                  </li>
                  <li>
                    <Link href="#">Luxury Properties</Link>
                  </li>
                  <li>
          ...
          <div className="details-page-content mb-130">
            ...
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  Archi Real Estate Agency is a premium property platform showcasing 
                  exclusive residential and commercial properties. The website serves 
                  as a comprehensive real estate portal, featuring high-end properties 
                  and demonstrating the agency's expertise in luxury real estate 
                  transactions.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  The portfolio highlights an impressive collection of premium properties, 
                  from luxurious penthouses to commercial complexes, emphasizing the 
                  agency's strong market presence. Each listing showcases detailed 
                  property features, high-quality imagery, and comprehensive market 
                  analysis.
                </p>
              </div>
            </div>
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                <h3>Platform Features & Services</h3>
                <p>
                  Our platform is designed to provide an intuitive property search 
                  experience while showcasing premium real estate listings with 
                  comprehensive details and market insights.
                </p>
                <br />
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    Virtual property tours and HD imagery
                  </li>
                  <li>
                    <svg
                      width={16}
                  ...
                  <li>
                    ...
                    Direct agent contact and viewing scheduling
                  </li>
                </ul>
              </div>
              <div className="col-lg-6">
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                ...
                <p>
                  The platform leverages advanced technologies to deliver a seamless 
                  property search and viewing experience. The responsive design ensures 
                  optimal viewing across all devices, while maintaining the visual 
                  impact of property listings.
                </p>
                <br />
                <p>
                  We implemented sophisticated property search algorithms and filters 
                  to help users find their ideal properties efficiently. The platform 
                  features real-time market data integration and automated property 
                  valuation tools to provide accurate market insights.
                </p>
              </div>
            </div>
            <span className="line-break" />
