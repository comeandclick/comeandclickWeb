      ...
      <div className="details-page-wrapper portfolio-details pt-130 pb-130">
        <div className="container-lg container-fluid">
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Doug : Votre Assistant IA Personnel</h1>
                <ul className="post-category">
                  ...
                  <li>
                    <Link href="#">Assistant Virtual</Link>
                  </li>
                  <li>
          ...
          <div className="details-page-content mb-130">
            ...
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  Doug est un assistant virtuel intelligent conçu pour simplifier votre 
                  quotidien. Alimenté par les dernières avancées en intelligence 
                  artificielle, Doug offre une expérience conversationnelle naturelle 
                  et intuitive pour répondre à vos besoins.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  Notre chatbot se distingue par sa capacité à comprendre le contexte, 
                  à apprendre de chaque interaction et à fournir des réponses 
                  pertinentes et personnalisées. Doug est votre compagnon idéal pour 
                  une assistance quotidienne efficace.
                </p>
              </div>
            </div>
            <span className="line-break" />
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                <h3>Fonctionnalités & Capacités</h3>
                <p>
                  Doug est équipé d'une large gamme de fonctionnalités conçues pour 
                  répondre à vos besoins spécifiques, qu'il s'agisse d'assistance 
              ...
              <div className="col-lg-6">
                <img src="/assets/img/doug/5.png" alt="" />
              </div>
            </div>
            <span className="line-break" />
            <span className="line-break" />
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                ...
                <p>
                  Doug utilise les dernières avancées en intelligence artificielle 
                  et en traitement du langage naturel pour offrir une expérience 
                  conversationnelle fluide et naturelle.
                </p>
                <br />
                <p>
                  Notre technologie s'adapte en permanence à vos besoins et 
                  préférences, créant une expérience personnalisée qui s'améliore 
