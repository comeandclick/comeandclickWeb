            ...
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">
                  EventHub - Event Management Mobile App
                </h1>
          ...
          <div className="details-page-content mb-130">
            ...
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  EventHub is a comprehensive mobile application designed to revolutionize 
                  event management and social gathering experiences. The app serves as a 
                  one-stop platform for discovering, planning, and managing events, while 
                  connecting event organizers with their target audience through an 
                  intuitive and engaging interface.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  The application features a modern, user-friendly design that prioritizes 
                  seamless navigation and efficient event discovery. With integrated social 
                  features, real-time updates, and sophisticated event management tools, 
                  EventHub transforms how people connect and experience events in their 
                  community.
                </p>
              </div>
            </div>
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                ...
                <p>
                  Our design approach focused on creating an engaging and intuitive mobile 
                  experience that simplifies event discovery and management while fostering 
                ...
                <ul>
                  <li>
                    ...
                    Smart event discovery with AI-powered recommendations
                  </li>
                  <li>
                    <svg
                      width={16}
                  ...
                  <li>
                    ...
                    Social networking and event sharing features
                  </li>
                  <li>
                    <svg
                      width={16}
                    ...
                    Real-time event analytics and attendee management
                  </li>
                </ul>
              </div>
              <div className="col-lg-6">
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                ...
                <p>
                  EventHub was developed using React Native to ensure a consistent and 
                  high-performance experience across both iOS and Android platforms. The 
                  backend infrastructure utilizes cloud services for scalability and 
                  real-time data synchronization.
                </p>
                <br />
                <p>
                  We implemented advanced features such as real-time notifications, 
                  location-based event discovery, and secure payment processing. The app's 
                  architecture was designed to handle high user loads and ensure smooth 
                  performance during peak event periods.
                </p>
              </div>
            </div>
            <span className="line-break" />
