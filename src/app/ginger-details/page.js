      ...
      <div className="details-page-wrapper portfolio-details pt-130 pb-130">
        <div className="container-lg container-fluid">
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Ginger : Votre Salon de Beauté de Confiance</h1>
                <ul className="post-category">
                  <li>
                    <Link href="#">Coiffure</Link>
                  </li>
                  <li>
                    <Link href="#">Soins</Link>
                  </li>
                  <li>
                    <Link href="#">Beauté</Link>
                  </li>
                  <li>
                    <Link href="#">Bien-être</Link>
                  </li>
                </ul>
              </div>
            </div>
                ...
                >
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/ginger/1.png"
                        alt="Salon Ginger intérieur"
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
                          display: "block",
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/ginger/2.png"
                        alt="Coiffure et soins"
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
                          display: "block",
          ...
          <div className="details-page-content mb-130">
            <h3>À Propos de Ginger</h3>
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  Ginger est une chaîne de salons de beauté haut de gamme, offrant une 
                  expérience complète de bien-être et de beauté. Nos salons combinent 
                  expertise professionnelle et atmosphère accueillante pour créer un 
                  environnement où chaque client se sent spécial.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  Notre engagement envers l'excellence se reflète dans chaque service 
                  que nous proposons. Nos stylistes et esthéticiennes qualifiés 
                  utilisent les dernières techniques et produits premium pour 
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                <h3>Nos Services</h3>
                <p>
                  Chez Ginger, nous proposons une gamme complète de services de beauté 
                  et de bien-être, adaptés aux besoins uniques de chaque client.
                </p>
                <br />
                <ul>
                  <li>
                    ...
                    Coiffure et styling personnalisé
                  </li>
                  <li>
                    <svg
                      width={16}
              ...
              <div className="col-lg-6">
                <img src="/assets/img/ginger/2.png" alt="Intérieur du salon" />
              </div>
            </div>
            <span className="line-break" />
            <span className="line-break" />
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                ...
                <p>
                  Nos professionnels sont formés aux dernières tendances et techniques 
                  de l'industrie de la beauté. Nous utilisons exclusivement des 
                  produits de haute qualité pour garantir les meilleurs résultats.
                </p>
                <br />
                <p>
                  Chaque visite chez Ginger est une expérience personnalisée, où 
                  nous prenons le temps de comprendre vos besoins et préférences 
                  pour créer un look qui vous correspond parfaitement.
                </p>
              </div>
            </div>
            <span className="line-break" />
