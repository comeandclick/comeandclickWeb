          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Arise - Digital Marketing Agency</h1>
          ...
          <div className="details-page-content mb-130">
            ...
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  Arise is a cutting-edge digital marketing agency website
                  designed to showcase comprehensive digital solutions and
                  services. The website serves as a powerful platform
                  demonstrating the agency's expertise in digital strategy,
                  content marketing, SEO, and social media management,
                  effectively communicating their ability to drive business
                  growth through digital channels.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  The website features a modern, dynamic design with interactive
                  elements that highlight the agency's innovative approach. Each
                  section is carefully crafted to demonstrate their strategic
                  thinking and creative capabilities, while maintaining a
                  professional and sophisticated aesthetic that resonates with
                  their target audience of businesses seeking digital
                  transformation.
                </p>
              </div>
            </div>
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                ...
                <p>
                  Our development approach focused on creating an engaging and
                  high-performance platform that effectively communicates the
                  agency's digital marketing expertise while providing an
                ...
                <ul>
                  <li>
                    ...
                    Interactive service showcases with detailed case studies
                  </li>
                  <li>
                    <svg
                      width={16}
                  ...
                  <li>
                    ...
                    Advanced lead generation and tracking system
                  </li>
                  <li>
                    <svg
                      width={16}
                    ...
                    Automated marketing campaign management tools
                  </li>
                </ul>
              </div>
              <div className="col-lg-6">
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                ...
                <p>
                  The website was developed using cutting-edge technologies and
                  frameworks to ensure optimal performance and scalability. We
                  implemented advanced SEO practices and performance
                  optimization techniques to enhance visibility and user
                  experience.
                </p>
                <br />
                <p>
                  Key technical features include a custom-built CMS for easy
                  content management, integrated analytics tools for tracking
                  campaign performance, and automated lead nurturing systems.
                  The platform is built with scalability in mind, allowing for
                  easy integration of new features and services as the agency
                  grows.
                </p>
              </div>
            </div>
