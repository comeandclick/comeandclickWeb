      ...
      <div className="details-page-wrapper portfolio-details pt-130 pb-130">
        <div className="container-lg container-fluid">
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Account Planet : Revendeur Numérique en Ligne</h1>
                <ul className="post-category">
                  <li>
                    <Link href="#">Revendeur Digital</Link>
                  </li>
                  <li>
                    <Link href="#">Services en Ligne</Link>
                  </li>
                  <li>
                    <Link href="#">Solutions Numériques</Link>
                  </li>
                  <li>
                ...
                >
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/accountPlanet/1.png"
                        alt=""
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/accountPlanet/2.png"
                        alt=""
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/accountPlanet/3.png"
                        alt=""
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/accountPlanet/4.png"
                        alt=""
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/accountPlanet/5.png"
                        alt=""
                        style={{
                          maxWidth: "85%",
                          margin: "0 auto",
          ...
          <div className="details-page-content mb-130">
            <h3>Aperçu de nos Services</h3>
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  Account Planet est votre partenaire de confiance pour tous vos besoins en services numériques. 
                  Nous proposons une large gamme de solutions digitales pour particuliers et professionnels, 
                  avec un accent particulier sur la qualité et la satisfaction client.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  Notre expertise s'étend sur différents domaines du numérique, offrant des solutions 
                  personnalisées et innovantes pour répondre aux besoins évolutifs de nos clients dans 
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                <h3>Nos Services Numériques</h3>
                <p>
                  Nous offrons une gamme complète de services numériques adaptés 
                  aux besoins modernes, avec des solutions innovantes et personnalisées.
                </p>
                <br />
                <ul>
                  <li>
              ...
              <div className="col-lg-6">
                <img src="/assets/img/accountPlanet/5.png" alt="" />
              </div>
            </div>
            <span className="line-break" />
            <span className="line-break" />
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                ...
                <p>
                  Nous nous engageons à fournir des services numériques de haute qualité, 
                  avec une attention particulière à la sécurité et à la satisfaction de nos clients. 
                  Chaque service est soigneusement sélectionné et vérifié pour garantir une expérience optimale.
                </p>
                <br />
                <p>
                  Notre équipe d'experts est disponible en permanence pour vous accompagner 
                  et vous conseiller dans le choix des meilleures solutions adaptées à vos besoins numériques.
                </p>
              </div>
            </div>
            <span className="line-break" />
...
export default AccountPlanetDetails;
