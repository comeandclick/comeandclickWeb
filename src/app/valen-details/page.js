          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Valen : Spécialiste du Revêtement en Béton</h1>
                <ul className="post-category">
                  <li>
                    <Link href="#">Béton Décoratif</Link>
                  </li>
                  <li>
                    <Link href="#">Revêtement</Link>
                  </li>
                  <li>
                    <Link href="#">Construction</Link>
                  </li>
                  <li>
                    <Link href="#">Rénovation</Link>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="details-page-content mb-130">
            ...
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  Valen est une entreprise spécialisée dans le revêtement en béton, 
                  offrant des solutions innovantes et durables pour vos projets de 
                  construction et de rénovation. Notre expertise s'étend du béton 
                  décoratif aux applications industrielles, en passant par les 
                  aménagements extérieurs.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  Nous nous distinguons par notre savoir-faire technique et notre 
                  engagement envers la qualité. Chaque projet est traité avec une 
                  attention particulière aux détails, garantissant des finitions 
                  impeccables et des résultats qui dépassent les attentes de nos clients.
                </p>
              </div>
            </div>
            <span className="line-break" />
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                ...
                <p>
                  Notre approche se concentre sur la création de solutions 
                  personnalisées qui répondent parfaitement aux besoins spécifiques 
                  de chaque client, tout en assurant une durabilité et une 
                  esthétique optimales.
                </p>
                <br />
                <ul>
                  <li>
                    ...
                    Béton décoratif et solutions personnalisées
                  </li>
                  <li>
                    <svg
                      width={16}
                  ...
                  <li>
                    ...
                    Solutions d'aménagement extérieur
                  </li>
                  <li>
                    <svg
                      width={16}
              ...
              <div className="col-lg-6">
                <img src="/assets/img/valen/5.png" alt="" />
              </div>
            </div>
            <span className="line-break" />
            <span className="line-break" />
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                ...
                <p>
                  Nous utilisons des technologies de pointe et des matériaux 
                  innovants pour garantir des résultats exceptionnels. Notre 
                  équipe expérimentée maîtrise les dernières techniques de 
                  mise en œuvre du béton.
                </p>
                <br />
                <p>
                  Chaque projet bénéficie d'une attention particulière à la 
                  préparation des surfaces et à l'application des revêtements, 
                  assurant ainsi une durabilité maximale et une finition 
                  irréprochable.
                </p>
              </div>
            </div>
