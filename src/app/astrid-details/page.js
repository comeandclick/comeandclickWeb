          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Astrid - Photography Portfolio.</h1>
          ...
          <div className="details-page-content mb-130">
            ...
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  Astrid Photography Portfolio is a stunning showcase website
                  designed to highlight the artistic vision and professional
                  work of a talented photographer. The website serves as a
                  digital gallery, presenting a diverse collection of
                  photography work including portraits, landscapes, and studio
                  photography.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  The portfolio features an elegant and minimalist design that
                  puts the focus entirely on the photography, with smooth
                  transitions and intuitive navigation that enhances the viewing
                  experience. Each image is carefully presented to tell its own
                  story while contributing to the overall narrative of the
                  photographer's artistic journey.
                </p>
              </div>
            </div>
            <span className="line-break" />
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                ...
                <p>
                  Our approach focused on creating a seamless and visually
                  engaging experience that would showcase the photographer's
                  work in its best light while maintaining optimal performance
                  and user experience.
                </p>
                <br />
                <ul>
                  <li>
                    ...
                    Responsive image gallery with smooth transitions and elegant
                    animations
                  </li>
                  <li>
                    <svg
                    ...
                    Optimized image loading for fast performance across all
                    devices
                  </li>
                  <li>
                    <svg
                    ...
                    Customizable portfolio categories and filtering options
                  </li>
                  <li>
                    <svg
                      width={16}
                    ...
                    Contact form integration for client inquiries and bookings
                  </li>
                </ul>
              </div>
              <div className="col-lg-6">
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                ...
                <p>
                  The website was built using modern web technologies to ensure
                  optimal performance and user experience. We implemented a
                  responsive design that adapts seamlessly to different screen
                  sizes and devices.
                </p>
                <br />
                <p>
                  Special attention was paid to image optimization and loading
                  strategies to ensure quick load times while maintaining the
                  high quality of the photography work. The gallery features
                  smooth transitions and intuitive navigation controls for an
