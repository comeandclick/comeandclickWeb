          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Akram - Interior Design Studio.</h1>
          ...
          <div className="details-page-content mb-130">
            ...
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  Akram Interior Design Studio is a sophisticated website showcasing 
                  the exceptional work of a premier interior design firm. The website 
                  serves as a comprehensive portfolio, featuring stunning residential 
                  and commercial interior design projects that demonstrate the studio's 
                  expertise in creating elegant, functional spaces.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  The portfolio exhibits a perfect blend of modern aesthetics and 
                  timeless design principles, highlighting the studio's ability to 
                  transform spaces into beautiful, livable environments. Each project 
                  showcases the firm's attention to detail, innovative use of materials, 
                  and commitment to delivering exceptional interior design solutions.
                </p>
              </div>
            </div>
            <span className="line-break" />
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                ...
                <p>
                  Our approach focused on creating an immersive digital experience 
                  that effectively communicates the studio's design philosophy while 
                  showcasing their impressive portfolio of interior design projects.
                </p>
                <br />
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    High-resolution project imagery with zoom functionality
                  </li>
                  <li>
                    <svg
                      width={16}
                    ...
                    Project categorization by style and space type
                  </li>
                  <li>
                    <svg
                      width={16}
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                ...
                <p>
                  The website was developed using cutting-edge technologies to ensure 
                  optimal performance and user experience. The responsive design adapts 
                  flawlessly across all devices, maintaining the visual impact of the 
                  interior design projects.
                </p>
                <br />
                <p>
                  We implemented advanced image optimization techniques to showcase the 
                  intricate details of each interior design project while maintaining 
                  fast loading times. The project gallery features smooth transitions 
                  and intuitive navigation to create an engaging browsing experience.
                </p>
              </div>
            </div>
            <span className="line-break" />
